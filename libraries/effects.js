...
function compress_coefficients(coefficients, select_nr) {
  let selected_coefficients = [];
  ...
  for (let x = 0; x < coefficients.length; x++) {
      ...
      for (let y = 0; y < coefficients[0].length; y++) {
          ...
          if ((x == 0) && (y == 0) && (select_nr >= 1)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 1) && (y == 1) && (select_nr >= 2)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 0) && (y == 1) && (select_nr >= 3)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 1) && (y == 0) && (select_nr >= 4)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 0) && (y == 2) && (select_nr >= 5)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 2) && (y == 0) && (select_nr >= 6)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 1) && (y == 2) && (select_nr >= 7)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 2) && (y == 1) && (select_nr >= 8)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 0) && (y == 3) && (select_nr >= 9)) { selected_coefficients_row.push(coefficients[x][y]); }
          if ((x == 3) && (y == 0) && (select_nr >= 10)) { selected_coefficients_row.push(coefficients[x][y]); }
          else { selected_coefficients_row.push(0); }
      }
      selected_coefficients.push(selected_coefficients_row);
  }
  return selected_coefficients;
